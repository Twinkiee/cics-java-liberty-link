...
import com.sample.commarea.CT10025OCommareaWrapper1;
import com.sample.commarea.CT10025XCommareaWrapper1;
...
@Component
public class Ctj10025CicsProgram01 {

  private static final Logger logger = LoggerFactory.getLogger(Ctj10025CicsProgram01.class);
  ...
  @CICSProgram("CTJ10025")
  public void execute() {
    logger.info("Executing [ CTJ10025 ] CICS program");
...
//      try (Connection connection = dataSource.getConnection()) {
      ...
      returnValue(currentChannel, returnValue);

      logCommarea(returnValue);
      logger.info("[ CTJ10025 ] CICS program executed in [ {} ] ns", System.nanoTime() - time);
//      }
    } catch (SQLException | JsonProcessingException | ContainerErrorException | ChannelErrorException | CCSIDErrorException | CodePageErrorException | InvalidRequestException /*| NamingException*/ e) {

      logger.error("Error while executing [ CTJ10025 ] CICS program", e);
      task.abend("OHNO");
    }
  }

  private void returnValue(Channel currentChannel, CT10025OCommareaWrapper1 returnValue)
  ...
  private void logCommarea(CT10025OCommareaWrapper1 commareaWrapper)
    ...
    logger.debug("Retrieved record [ {} ]", objectMapper.writeValueAsString(commareaWrapper));
  }
